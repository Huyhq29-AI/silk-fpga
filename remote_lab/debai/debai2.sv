...
// =========================================================================
// 1. TOP MODULE (WRAPPER SẠCH SẼ - CHỈ LÀM NHIỆM VỤ ĐI DÂY)
// =========================================================================
module top_module (
    input  wire       clk,
    input  wire       rst_n,
    input  wire [7:0] SW,       // SW[3:0] chỉnh tốc độ rắn
    input  wire [1:0] KEY,      // KEY[0]: Rẽ Trái, KEY[1]: Rẽ Phải
    output wire       hsync,    
    output wire       vsync,    
    output reg  [1:0] r,        
    output reg  [1:0] g,        
  ...
  // --- Dây tín hiệu giao tiếp giữa các khối ---
  wire [1:0]   state;
  ...
  // =========================
  // Instance 2: Khối Điều Khiển Trung Tâm (Gom toàn bộ logic)
  // =========================
...
// =========================================================================
// 2. MODULE GAME_CTRL: BỘ NÃO QUẢN LÝ LUỒNG TRÒ CHƠI
// =========================================================================
module game_ctrl (
    input  wire        clk,
    input  wire        rst_n,
  ...
  // --- Quản lý hướng đi (Chống tự sát kép) ---
  reg [1:0] dir; 
  reg turn_handled;
  ...
  // --- Ép phẳng mảng (Flattening) truyền ra ngoài ---
  genvar gi;
  generate
...
// =========================================================================
// 3. MODULE COLLISION: XỬ LÝ VA CHẠM TƯỜNG VÀ TỰ CẮN
// =========================================================================
module collision (
...
// =========================================================================
// 4. MODULE RENDERER: VẼ PIXEL LÊN MÀN HÌNH VGA
// =========================================================================
module renderer (
...
// =========================================================================
// 5. MODULE HVSYNC_GENERATOR: TẠO XUNG VGA (640x480 @ 60Hz)
// =========================================================================
